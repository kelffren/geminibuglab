...
try{
  ...
  // Invariant-safe facade: never Proxy a frozen admin object. Copy its callable API
  // onto a fresh mutable object, overriding only authorization for this isolated lab.
